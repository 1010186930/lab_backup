...
//江南
  ...
  */
  ...
  ft1=fopen("C:\\Users\\Administrator\\Desktop\\分词结果.txt","r");
  ft2=fopen("C:\\Users\\Administrator\\Desktop\\text.txt","w");
  fd1=fopen("C:\\Users\\Administrator\\Desktop\\盲文块.txt","r+");
  fd2=fopen("C:\\Users\\Administrator\\Desktop\\data.txt","w");
  char bufferd[127];
  char buffert[38];
  char bd[7];
  char br0[7];
