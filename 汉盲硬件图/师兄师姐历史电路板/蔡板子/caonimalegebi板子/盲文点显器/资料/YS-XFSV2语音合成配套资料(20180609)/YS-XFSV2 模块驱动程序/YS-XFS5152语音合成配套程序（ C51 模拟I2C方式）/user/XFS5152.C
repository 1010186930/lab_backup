...
/**************芯片设置命令*********************/
uint8_t code XFS_StopCom[]={0xFD,0X00,0X01,0X02};//停止合成
uint8_t code XFS_SuspendCom[]={0XFD,0X00,0X01,0X03};//暂停合成
uint8_t code XFS_RecoverCom[]={0XFD,0X00,0X01,0X04};//恢复合成
uint8_t code XFS_ChackCom[]={0XFD,0X00,0X01,0X21};//状态查询
uint8_t code XFS_PowerDownCom[]={0XFD,0X00,0X01,0X88};//进入POWER DOWN 状态命令
...
{
/****************需要发送的文本**********************************/ 
		 unsigned  char xdata Frame_Info[45];
...
/*******************发送帧信息***************************************/		  
		 ...
		 I2CSendData(Frame_Info,5+HZ_Length); //发送帧配置
