...
void LCD_Draw_Ellipse(u16 x0, u16 y0, u16 rx, u16 ry,u16 color)
{
    ...
    for (y=0; y<=ry; y++)
    {
        ...
        if (y)
        {
            LCD_Fast_DrawLine(x0-xOld,y0-y+1,x0-x,y0-y,color);
            LCD_Fast_DrawLine(x0-xOld,y0+y-1,x0-x,y0+y,color);
            LCD_Fast_DrawLine(x0+xOld,y0-y+1,x0+x,y0-y,color);
            LCD_Fast_DrawLine(x0+xOld,y0+y-1,x0+x,y0+y,color);
        }
...
void LCD_Fast_DrawLine(u16 x0,u16 y0,u16 x1,u16 y1,u16 color)
{
    u16 t;
    int xerr=0,yerr=0,delta_x,delta_y,distance;
    int incx,incy,uRow,uCol;
