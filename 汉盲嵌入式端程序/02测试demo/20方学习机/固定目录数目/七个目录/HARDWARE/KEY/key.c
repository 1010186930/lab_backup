...
{	 
	...
	if(key_up&&(KEY0==0||KEY1==0||KEY2==0||KEY3==0||KEY4==0))
	{
		delay_ms(10);//去抖动 
		key_up=0;
		if(KEY0==0)return KEY0_PRES;//1,OK
		else if(KEY1==0)return KEY1_PRES;//3,
		else if(KEY2==0)return KEY2_PRES;//2,下一页
		else if(KEY3==0)return KEY3_PRES;	//4，下一页目录段
		else if(KEY4==0)return KEY4_PRES;//5，上一级
...
//	if(key_up&&(KEY0==0))
//	{
//		delay_ms(10);//10ms的延迟去抖动 
//		key_up=0;
//		if(KEY0==0)return KEY0_PRES ;//key0作为文件操控按钮。
