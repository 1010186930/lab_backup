...
{
	LCD_Fill(35,40,45,1000,WHITE);//清除原先位置，白色填充	
...
void UIfun(u8 state)
{
	...
	//			SPeech(name[key2]);
		...
		break;
		case 6:
			display("0:/02一年级课文（不带拼音）",key2,n2);
		break;
		case 7:
			display("0:/03一年级课文（带拼音）",key3,n3);
		break;
		case 8:
			display("0:/04古诗（不带拼音）",key4,n4);
		break;
	}
}
