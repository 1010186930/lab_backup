...
#define _DF1S	0x81	/*GBK 1st字节从0x81开始*/
#define _DF1E	0xFE	/*GBK 1st字节从0XFE结束*/
#define _DS1S	0x40	/*GBK 2st字节分为两个部分 part1 从0X40开始*/
#define _DS1E	0x7E	/*GBK 2st part1 从0X7E结束*/
#define _DS2S	0x80	/*GBK 2st part2 从0X80开始*/
#define _DS2E	0xFE	/*GBK 2st part2 从0XFE结束*/
...
)
{
	...
	while (n < len - 1) {	/* Read characters until buffer gets filled */
		...
		c = s[0];
#endif
		if (_USE_STRFUNC == 2 && c == '\r') continue;	/* Strip '\r' CR*/
		*p++ = c;
		n++;
		if (c == '\n') break;		/* Break on EOL */
	}
